...
export default function Instructions({ showInstructions }) {
    ...
    return (
        ...
        >
            ...
            <p>Scoring: Each time food is eaten, your score will increase by the current legnth of the snake, plus a time bonus for reaching the next food pellet quickly</p>
